namespace n_Car
{
    ...
    public class Car : FuelVehicle
    {
        ...
        public override string ToString()
        {
            ...
            vehicleDetails.AppendLine(string.Format(Strings.car_color, Garage.CarColor.s_CarColorNames[(int)m_CarColor]));
            vehicleDetails.AppendLine(string.Format(Strings.door_number, Garage.DoorNumber.s_DoorsOptions[(int)m_NumberOfDoors - 2]));
